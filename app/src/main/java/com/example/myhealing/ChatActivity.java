...
public class ChatActivity extends AppCompatActivity {
    ...
    void callAPI(String question){
        String prompt = "감정일기를 작성하는 '감정봇'입니다." +
                ...
                "무조건 당일 날짜로 일기를 작성하며, 일기는 [일기를 쓴 날짜, 제목, 감정(명사), 내용] 순서로 작성됩니다." +
                "단, 사용자가 대답한 메시지만 사용해서 일기를 작성하며 모든 질문에 사용자가 답변을 한 후에 '종료'라고 사용자가 요청하면 일기를 작성합니다." +
                "간결한 대화와 공감하는 말투, 그리고 존댓말을 사용하며, 사용자를 '당신'이라고 호칭합니다.";
